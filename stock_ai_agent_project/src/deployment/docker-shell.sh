...
# export IMAGE_NAME="stockbusters-app-deployment"
# export BASE_DIR=$(pwd)
# export SECRETS_DIR=$(pwd)/../../secrets/
# export SSH_DIR=$(pwd)/../../secrets/
# # export SECRETS_DIR=$(pwd)/../../../secrets/ac215-project/
# # export SSH_DIR=$(pwd)/../../../secrets/ac215-project/
# export GCP_PROJECT="stock-busters-cs115" # Change to your GCP Project
# export GCP_REGION="us-central1"
# export GCP_ZONE="us-central1-a"
# export GOOGLE_APPLICATION_CREDENTIALS=/secrets/deployment.json
# export PULUMI_BUCKET="gs://$GCP_PROJECT-stock-busters-cs115-pulumi-state-bucket"
# export PULUMI_BUCKET_REGION="us-central1"
...
#     -v "$BASE_DIR/../api-service":/app/api-service \
#     -v "$BASE_DIR/../frontend":/app/frontend \
#     -v "$BASE_DIR/../vector-db":/app/vector-db \
...
export SECRETS_DIR=$(pwd)/../../secrets/
export SSH_DIR=$(pwd)/../../secrets/
export GCP_PROJECT="stock-busters-cs115"
export GCP_REGION="us-central1"
export GCP_ZONE="us-central1-a"
export GOOGLE_APPLICATION_CREDENTIALS=/secrets/deployment.json
