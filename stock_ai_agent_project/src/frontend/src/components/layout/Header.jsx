...
import { Home, Menu, X, BarChart, List, Grid3x3, Bot, MapPin, SettingsIcon } from 'lucide-react';
...
export default function Header() {
    ...
    const navItems = [
        ...
        { name: 'AI SmartInvestor', path: '/chat', icon: <Bot className="h-5 w-5" /> },
        { name: 'Settings', path: '/Settings', icon: <SettingsIcon className="h-5 w-5" /> },
        { name: 'About US', path: '/about', icon: <BarChart className="h-5 w-5" /> }
                    ...
                    <div className="header-content">
                        <Link href="/" className="header-logo">
                            <Image
                                ...
                                className="w-8 h-8"
                            />
                            <h1 className="text-xl font-bold font-montserrat">Stock Busters</h1>
                        </Link>
